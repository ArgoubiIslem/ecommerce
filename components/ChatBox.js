          ...
          {showModal ? (
            <>
              ...
              <div class="chat-services expand flex flex-col overflow-auto bg-gray-200 px-2">
                ...
                <div class="message my-2 ml-3 self-end rounded-md bg-pink-700 p-2 text-white shadow">
              ...
              <div class="relative bg-white">
                ...
                />
                <button class="transistion-color absolute right-0 bottom-0 m-1  w-auto bg-white px-3 py-1 text-pink-700 duration-100 hover:text-pink-700 focus:outline-none">
                  Send
                </button>
              </div>
            </>
